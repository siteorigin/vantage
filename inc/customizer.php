	...
	$settings = apply_filters( 'vantage_premium_customizer_settings', array(
		...
		'vantage_fonts' => array(
			...
			'content_heading_color' => array(
				...
				'default' => '#444444',
				'selector' => '.entry-content h1, .entry-content h2, .entry-content h3, .entry-content h4, .entry-content h5, .entry-content h6, #comments .commentlist article .comment-author a, #comments-title, #reply-title, #commentform label',
				'property' => array('color'),
			),
		),
		'vantage_general' => array(
